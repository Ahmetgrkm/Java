...
public class İdman {
    ...
    public void burpeeYap(int sayi){
        ...
        if (burpee_sayisi-sayi<0){
            System.out.print("Hedeflediğin burpee sayısını geçtin tebrikler...");
            burpee_sayisi=0;
            System.out.print("Kalan burpee sayısı :" + burpee_sayisi);
        }
        else {
            burpee_sayisi-=sayi;
    ...
    public void pushupYap(int sayi){
        ...
        if (pushup_sayisi-sayi<0){
            System.out.print("Hedeflediğin pushup sayısını geçtin tebrikler...");
            pushup_sayisi=0;
    ...
    public void situpYap(int sayi){
        ...
        if (situp_sayisi-sayi<0){
            System.out.print("Hedeflediğin situp sayısını geçtin tebrikler...");
            situp_sayisi=0;
    ...
    public void squatYap(int sayi){
        ...
        if (squat_sayisi-sayi<0){
            System.out.print("Hedeflediğin squat sayısını geçtin tebrikler...");
            squat_sayisi=0;
